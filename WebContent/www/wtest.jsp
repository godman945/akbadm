...
<head>
    ...
    <meta name="application-name" content="PChome Online 網路家庭" />
    ...
    <meta property="og:image" content="http://www.pchome.com.tw/img/pchomelogo_fb.jpg" />
    ...
    <title>PChome Online 網路家庭</title>
    ...
    <div class="wrapper rwd">
        <div class="container">
                                ...
                                <div class="topbar-toprow txt-table w-full">
                                    ...
                                    <div class="txt-cell cm p-l8 pos-relative">
                                        ...
                                        <div class="txt-table search-box">
                                            <div class="txt-cell">
                                                <input class="p-lr8" type="search" value="" autocomplete="off" placeholder="請輸入關鍵字或商品名">                               
                                            </div>
                                            <div class="txt-cell">
                                                <div class="search-btn flt-right ali-middle">
                                        ...
                                        <div class="tripple-wrap">
                                            ...
                                            <a href="#">
                                                <div class="tripple-box flt-left aqi txt-table">
                                                    <span data-scale="uhforsens"><small>AQI</small><b data-aqi="53"></b></span>
                                                    <div class="txt-cell txt-left">空氣品質<b data-scale="uhforsens">對敏感族群不健康</b></div>
                                                </div>
                                            </a>
                                            <!-- 氣象報告 -->
                                            <a href="#">
                                                <div class="tripple-box flt-left weather">
                                                    <b class="txt-top">台北市</b>
                                                    <em data-icon="wh17N"></em>
                                                    <span>31&#176;<small>23&#176;/28&#176;</small></span>
                                                </div>
                                            </a>
                                ...
                                <div class="topbar-bottomrow txt-table w-full">
                                    ...
                                    <div class="txt-cell rt">
                                        ...
                                        <script>
                                            ...
                                            _login.querySelector('a').innerHTML=_login.getAttribute('data-type');
                                        </script>
            ...
            <div class="content-wrap p-16">
                ...
                <!-- 主資訊 -->
                <!-- 內容 主要輪播 -->
                <div class="content-box primaryPush p-b16">

                    <div class="rt flt-right">
                        <!-- 找東西搜尋開始 -->
                        <div class="txt-table findsearch-box">
                            <div class="txt-cell lf">找東西</div>
                            <div class="txt-cell rt">
                                <input type="search" value="" class="inp_txt" autocomplete="off" placeholder="香奈兒女性淡香精">
                                <span type="submit" class="icon-searchFD"></span>
                                <span class="icon-kwFD"></span>                                  
                            </div>
                        </div>
                        <!-- 找東西搜尋結束 -->
                        <!-- 右欄廣告開始 -->
                ...
                <!-- 聯播網廣告 -->
                <div data-display="block" class="adbell-box txt-center m-b16">
                    <div class="ad-box txt-inlineblock">
                        <!--970x250-->
                        <script language="javascript">
                        pad_width=970;
                        pad_height=250;
                    ...
                    <div class="ad-box flt-right p-l16">
                        <!--300x250-->
                        <script language="javascript">
                            pad_width = 300;
                            pad_height = 250;
                        ...
                        <div class="p-r16">
                            <!-- 推播專區 內容開始 -->
                                ...
                                <ul class="tab-box txt-table">
                                    <li class="txt-cell" onmouseover="$('.tab-box li').attr('data-tab','normal');$(this).attr('data-tab','active')" data-tab="active">熱搜美食</li>
                                    <li class="txt-cell" onmouseover="$('.tab-box li').attr('data-tab','normal');$(this).attr('data-tab','active')" data-tab="">火熱旅遊</li>
                                    <li class="txt-cell" onmouseover="$('.tab-box li').attr('data-tab','normal');$(this).attr('data-tab','active')" data-tab="">內幕外流</li>
                                    <li class="txt-cell" onmouseover="$('.tab-box li').attr('data-tab','normal');$(this).attr('data-tab','active')" data-tab="">驚爆娛樂</li>
                                    <li class="txt-cell" onmouseover="$('.tab-box li').attr('data-tab','normal');$(this).attr('data-tab','active')" data-tab="">時事評論</li>
                                    <li class="txt-cell" onmouseover="$('.tab-box li').attr('data-tab','normal');$(this).attr('data-tab','active')" data-tab="">人氣文章</li>
                                </ul>
                                <!-- 推播標籤結束 -->
                                
                                <!-- 標籤內容開始 -->
                                <div class="txt-table tagpost-box p-t16">
                                    <!-- 左欄大圖片開始 -->
                                    <div class="txt-cell txt-top lf">
                                        <a href="#">
                                        <div class="photo-box img-top p100 image-mask">
                                            <span class="image-gradient"></span>
                                            <img data-region="horizontal" src="http://i.epochtimes.com/assets/uploads/2018/04/180403081217100707-600x400.jpg">
                                            <div class="image-txt-wrap">
                                                <h3 class="image-txt txt-left">
                                                美國版《蒙面歌王》開播　WINNER、BTS防彈少年團、Wanna One 應援影片亮點滿滿！</h3>
                                            </div>  
                                        </div>
                                        </a>                                          
                                    </div>
                                    ...
                                    <div class="txt-cell txt-top cm">
                                        ...
                                        <div class="txt-table txt-left">
                                            <div class="txt-cell txt-top p-16">
                                              <a href="#" class="a-link">                         
                                                <div class="photo-box img-top p71">
                                                    <img class="top" data-region="horizontal" src="https://i.pinimg.com/originals/fb/e5/d8/fbe5d88bc4bf1d4c865e837447d58312.jpg">    
                                                </div>
                                                <h6 class="p-t16">BTS防彈少年團《Love Yourself》加場演出　新紀錄電影預告出爐！</h6>
                                              </a>
                                            </div>
                                            ...
                                            <div class="txt-cell txt-top p-16">
                                              <a href="#" class="a-link">                           
                                                <div class="photo-box img-top p71">
                                                    <img class="top" data-region="vertical" src="http://news.pchome.com.tw/newsdata/entertainment/nownews/20190107/54682484443946207006.jpg">                                                   
                                                </div>
                                                <h6 class="p-t16">金球獎／道格拉斯奪第一獎 最佳動畫《蜘蛛人：新宇宙》</h6>
                                              </a>
                                            </div>
                                            <div class="txt-cell txt-top p-16">
                                              <a href="#" class="a-link">                            
                                                <div class="photo-box img-top p71">
                                                    <img class="top" data-region="vertical" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR7Y7slUdMA-YxgL1Hyh82Ndz_bEffP-26bQ67iN7Zor5z6t29Z">                                                   
                                                </div>
                                                <h6 class="p-t16">爆冷擊敗一個巨星 波希米亞狂想曲連奪兩大獎</h6>
                                               </a>
                                            </div>
                                        </div> 
                                        <!-- 第二排 -->
                                        <div class="txt-table txt-left">
                                            <div class="txt-cell txt-top p-16">
                                              <a href="#" class="a-link">                              
                                                <div class="photo-box img-top p71">
                                                    <img class="top" data-region="vertical" src="http://news.pchome.com.tw/newsdata/entertainment/nownews/20190106/54675327701594207006.jpg">                                                   
                                                </div>
                                                <h6 class="p-t16">劉以豪《紅白》落漆韓文待客？金世正霸氣護航：他很溫暖</h6>
                                              </a>
                                            </div>
                                            ...
                                            <div class="txt-cell txt-top p-16">
                                              <a href="#" class="a-link">                            
                                                <div class="photo-box img-top p71">
                                                    <img class="top" data-region="horizontal" src="http://news.pchome.com.tw/newsdata/entertainment/nownews/20190104/54659942458998207006.jpg">                                                   
                                                </div>
                                                <h6 class="p-t16">更大猛料！潤娥跟「防彈少年團」的他 戀愛ing</h6>
                                              </a>
                                            </div>
                                            <div class="txt-cell txt-top p-16">
                                              <a href="#" class="a-link">                          
                                                <div class="photo-box img-top p71">
                                                    <img class="top" data-region="horizontal" src="http://news.pchome.com.tw/newsdata/entertainment/nownews/20190107/54682794950537207006.jpg">                                                   
                                                </div>
                                                <h6 class="p-t16">金球獎／女神卡卡哭了！《一個巨星的誕生》奪最佳主題曲</h6>
                                              </a>
                                            </div>
                                        </div>
                ...
                <!-- 內容 焦點快報 -->
                <div class="content-box has-border newsFocus transition-all">
                    ...
                    <div class="txt-table">
                        <div class="txt-row">
                            <div class="txt-cell txt-left txt-top lf">
                                ...
                                <div class="item-list p-lr32 p-b16 txt-left">
                                    <h5 class="txt-black p-tb16 p-l16">
                                        <a href="#" class="a-link">Skoda Fabia 小改款試駕後超有感! 聽說還有WRC 2奪冠驚喜價!外觀小幅修改後變得更有質感</a>
                                    </h5>
                                    <h5 class="txt-black p-tb16 p-l16">
                                        <a href="#" class="a-link">「BTS防彈少年團」擔任Hyundai Palisade全球品牌形象大使</a>
                                    </h5>
                                    <!-- 焦點快報 左欄廣告開始 -->
                            ...
                            <div class="txt-cell txt-left txt-top cm">
                                <div class="category-box p-tb16 p-lr32">
                                    <b class="category-tit">買車資訊</b>                                   
                                        <h2 class="txt-black p-tb8"><a href="#" class="a-link">向經典跑車致敬 Jaguar F-TYPE 化身為拉力賽車</a></h2>
                                        <p class="p-tb8">時逢 Jaguar 經典傳奇跑車 XK120 (1948 年誕生)問世 70 周年，Jaguar 不僅推出硬頂雙門的 F-TYPE Chequered Flag Limited Edition 限量版本，也同步以 F-TYPE Convertibles 為基礎打造兩輛 Rally 越野拉力版本向經典致敬。</p>
                                    
                                        <a href="#">
                                        <div class="photo-box p75">
                                            <img data-region="horizontal" src="http://news.pchome.com.tw/newsdata/car/liancar/20181229/54607154610434215018.jpg">
                                            <!-- <img data-region="vertical" src="https://cdn.carnews.com/upload/image/pY7ULzBYPSSP.jpg"> -->
                                        </div>
                                        </a>
                                </div>
                            </div>
                ...
                <!-- 內容 人氣話題 -->
                <div class="content-box has-border hottopic transition-all">

                    <!-- 人氣話題 header -->
                    <div class="content-titlebox ali-middle">
                        <em></em><span>人氣話題</span>
                        <a class="btn-more pos-absolute pos-middle" href="#">更多話題<i class="txt-arrow right"></i></a>
                    </div>
            ...
            <div class="footer-wrap transition-all">
                    ...
                    <div class="morelink-list">
                        <div class="txt-table w-full">
                            <div class="txt-cell txt-top txt-left">
                                <span><a href="#">線上購物</a></span>
                                <span><a href="#">24h購物</a></span>
                                <span><a href="#">購物中心</a></span>
                                <span><a href="#">商店街</a></span>
                                <span><a href="#">露天拍賣</a></span>
                                <span><a href="#">個人賣場</a></span>
                                <span><a href="#">日本代購</a></span>
                                <span><a href="#">買車</a></span>
                            </div>
                            <div class="txt-cell txt-top txt-left">
                                <span><a href="#">股市</a> | <a href="#">港股</a></span>
                                <span><a href="#">Lingvist</a></span>
                                <span><a href="#">旅行團</a></span>
                                <span><a href="#">Yiabi新聞</a></span>
                                <span><a href="#">信箱</a></span>
                                <span><a href="#">Skype</a></span>
                                <span><a href="#">新聞</a> | <a href="#">氣象</a></span>
                                <span><a href="#">雜誌</a> | <a href="#">時尚</a></span>
                                <span><a href="#">買賣租屋</a></span>
                                <span><a href="#">報稅</a> | <a href="#">繳稅</a></span>
                            </div>
                            <div class="txt-cell txt-top txt-left">
                                <span><a href="#">kaza隨拍</a></span>
                                <span><a href="#">PChome IM</a></span>
                                <span><a href="#">個人新聞台24</a></span>
                                <span><a href="#">找東西</a></span>
                                <span><a href="#">小遊戲</a></span>
                                <span><a href="#">線上麻將</a></span>
                                <span><a href="#">寵物派</a></span>
                                <span><a href="#">美學院</a></span>
                                <span><a href="#">togame</a></span>
                            </div>
                            <div class="txt-cell txt-top txt-left">
                                <span><a href="#">支付連</a></span>
                                <span><a href="#">國際連</a></span>
                                <span><a href="#">Pi 拍錢包</a></span>
                                <span><a href="#">ATM</a> | <a href="#">繳費</a></span>
                                <span><a href="#">IPEVO</a></span>
                                <span><a href="#">企業郵件</a></span>
                                <span><a href="#">學習進修</a></span>
                                <span><a href="#">網站空間</a></span>
                                <span><a href="#">照片沖印</a></span>
                                <span><a href="#">理財</a></span>
                            </div>
                            <div class="txt-cell txt-top txt-left">
                                <span><a href="#">EMBA課程</a></span>
                                <span><a href="#">基金</a></span>
                                <span><a href="#">店家刊登</a></span>
                                <span><a href="#">會員中心</a></span>
                                <span><a href="#">廣告刊登</a></span>
                                <span><a href="#">一元簡訊</a></span>
                                <span><a href="#">直播達人</a></span>
                                <span><a href="#">PChome注音</a></span>
                            </div>
                            <div class="txt-cell txt-top txt-left">
                                <span><a href="#">數位憑證</a></span>
                                <span><a href="#">企業簡訊</a></span>
                                <span><a href="#">健康樂活</a></span>
                                <span><a href="#">買網址</a></span>
                                <span><a href="#">虛擬主機</a></span>
                ...
                <div class="copyright-box txt-light">
                    <div class="copyright-list p-tb16">
                        <span><a href="counter.php?sid=804">廣告刊登</a>|</span>
                        <span><a href="counter.php?sid=809">隱私權聲明</a>|</span>
                        <span><a href="counter.php?sid=810" target="_blank">消費者保護</a>|</span>
                        <span><a href="counter.php?sid=812">兒童網路安全</a>|</span>
                        <span><a href="counter.php?sid=814">About PChome</a>|</span>
                        <span><a href="counter.php?sid=815">投資人聯絡</a>|</span>
                        <span><a href="counter.php?sid=816">徵才</a></span>
                    </div>
                    <div class="copyright-text p-tb8">網路家庭版權所有、轉載必究 ‧Copyright  PChome Online<p class="p-t8">PChome Online and PChome are trademarks of PChome Online Inc.</p></div>
                </div>
            </div>
