            ...
            if (this.parentElement.className == 'asynpchomead') {
                for (var k = 0; k < iframeArray.length; k++) {
                    if (this == iframeArray[k]) {
                        ...
                        var iframeHalf = iframeOriginalHeight / 2;
                        var controllerHeight = (viewHeight + iframeHalf) - iframeOriginalHeight;
                        var adInfo = '{"adInfo":{"scrollTop":' + scrollTop + ',"viewHeight":' + viewHeight + ',"iframeOffSetTop":' + iframeOffSetTop + ',"iframeBottom":' + iframeBottom + ',"iframeTop":' + iframeTop + ',"iframeHalf":' + iframeHalf + ',"controllerHeight":' + controllerHeight + ',"visibilitychange":' + false + '},"adBackup":{"iframeIndex":' + k + ',"ALEX":"asynpcadshow","httpType":' + padssl + '}}';
                        iframeWin.postMessage(adInfo, "*")
                    }
                }
            } else {
