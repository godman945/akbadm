...
<table class="table01">
    <tr>
        ...
        <td class="td01" width="90">申請時間</td>
        <td class="td01" width="200">申請人</td>
        <td class="td01" width="100">統一編號</td>
        <td class="td01" width="200">宣傳網址</td>
        <td class="td01" width="200">查詢結果</td>
        <td class="td01" width="200">退件原因</td>
    </tr>
    ...
    <tr>
        ...
        <td class="td02">${data.pfdCustomerInfoTitle!}</td>
