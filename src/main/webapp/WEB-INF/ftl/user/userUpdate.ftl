...
<h2><img src="<@s.url value="/" />html/img/iconcr.gif" hspace="2" vspace="12" align="absmiddle" />修改帳號</h2>
<form action="doUserUpdate.html" method="post">
<table width="450" class="table01">
    <tr>
        <td width="100" class="td01">帳號(E-mail)<font color="red">*</font></td>
        <td class="td02"> ${paramUserEmail!}</td>
    </tr>
    <tr>
                        ...
                        <select name="paramParentDeptId" id="paramParentDeptId">
                            ...
                            <#list parentDeptList as dept1>
                                ...
                                <#if paramParentDeptId?exists>
                                    <#if dept1.depId?string == paramParentDeptId>
                        ...
                        <select name="paramChildDeptId" id="paramChildDeptId">
                            ...
                            <#list childDeptList as dept2>
                                ...
                                <#if paramChildDeptId?exists>
                                    <#if dept2.depId?string == paramChildDeptId>
                                        <#assign selectedFlag="selected">
                                    </#if>
                                </#if>
    ...
    <tr>
        ...
        <td class="td02"> <textarea name="paramNote" cols=25 rows=2>${paramNote!}</textarea> ( 限 50 字元 )</td>
    </tr>
</table>
<br>
<table width="450">
...
<input type="hidden" name="paramUserEmail" value="${paramUserEmail!}" />
</form>
