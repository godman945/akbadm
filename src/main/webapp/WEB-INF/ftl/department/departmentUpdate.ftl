...
function addChildDept() {
    ...
    Td3.innerHTML = '<input type="hidden" name="childDeptId" value="" />';
    Td3.className = "td03";
}
...
function deleteChildDept(object) {
    document.getElementById("childDeptTab").deleteRow(object.parentElement.parentElement.rowIndex);
}
...
<table width="100%">
    <tr>
        <td class="td05">修改部門</td>
    </tr>
</table>
<br>
<form action="doDepartmentUpdate.html" method="post">
<table width="400">
    <tr><td>部門設定：</td></tr>
</table>
...
<#if childDeptList?exists>
    ...
    <tr>
        <td class="td03" style="background-color:#EEEEEE"><input type="text" name="childDeptName" value="${dept.depName!}" size="20" maxlength="20" /></td>
        <td class="td03" style="background-color:#EEEEEE"><input type="text" name="childDeptSort" value="${dept.sort!}" size="2" maxlength="2" /></td>
        <td class="td03" style="background-color:#EEEEEE">
            <input type="button" value="移除" onclick="deleteChildDept(this);">
            <input type="hidden" name="childDeptId" value="${dept.depId!}" />
        </td>
    </tr>
    </#list>
</#if>
...
<input type="hidden" name="deleteChildDeptId" value="">
</form>
