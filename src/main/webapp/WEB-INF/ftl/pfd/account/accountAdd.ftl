...
<h2><img src="<@s.url value="/" />html/img/iconcr.gif" hspace="2" vspace="12" align="absmiddle" />經銷商建立</h2>

<form action="doPfdAccountAdd.html" method="post">
...
<table width="600" class="table01">
    ...
    <tr>
        ...
        <td class="td02">
            <input type="radio" name="companyCategory" value="1" checked>經銷商 &nbsp;&nbsp;&nbsp;&nbsp;
            <input type="radio" name="companyCategory" value="2">代理商
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="td02">
            <input type="checkbox" id="pfpAdtypeBox1" name="pfpAdtypeBox1" value="1" checked />搜尋廣告+聯播網廣告
            <input type="checkbox" id="pfpAdtypeBox5" name="pfpAdtypeBox2" value="1" checked />搜尋廣告
            <input type="checkbox" id="pfpAdtypeBox9" name="pfpAdtypeBox3" value="1" checked />聯播網廣告
            <input type="hidden" id="pfpAdtypeSelect" name = "pfpAdtypeSelect" value="111111111111" />
        </td>
    </tr>
    <tr id="deviceTr1">
        <td width="100" class="td01">搜尋廣告+聯播網廣告</td>
        <td class="td02">
            <input type="checkbox" id="pfpAdtypeBox2" name="pfpAdtypeBox2" value="1" checked />電腦+行動裝置
            <input type="checkbox" id="pfpAdtypeBox3" name="pfpAdtypeBox3" value="1" checked />電腦
            <input type="checkbox" id="pfpAdtypeBox4" name="pfpAdtypeBox4" value="1" checked />行動裝置
        </td>
    </tr>
    <tr id="deviceTr5">
        <td width="100" class="td01">搜尋廣告</td>
        <td class="td02">
            <input type="checkbox" id="pfpAdtypeBox6" name="pfpAdtypeBox6" value="1" checked />電腦+行動裝置
            <input type="checkbox" id="pfpAdtypeBox7" name="pfpAdtypeBox7" value="1" checked />電腦
            <input type="checkbox" id="pfpAdtypeBox8" name="pfpAdtypeBox8" value="1" checked />行動裝置
        </td>
    </tr>
    <tr id="deviceTr9">
        <td width="100" class="td01">聯播網廣告</td>
        <td class="td02">
            <input type="checkbox" id="pfpAdtypeBox10" name="pfpAdtypeBox10" value="1" checked />電腦+行動裝置
            <input type="checkbox" id="pfpAdtypeBox11" name="pfpAdtypeBox11" value="1" checked />電腦
            <input type="checkbox" id="pfpAdtypeBox12" name="pfpAdtypeBox12" value="1" checked />行動裝置
        </td>
    </tr>
    <tr>
...
<table width="600" class="table01">
    ...
    <tr>
        ...
        <td class="td02"><input type="text" name="contactEmail" value="${contactEmail!}" size="30" maxlength="50" /> ( 限 50 字元 )</td>
    </tr>
</table>
<br>
...
<table width="600" class="table01">
    <tr>
        ...
        <td class="td02"><input type="text" id="totalQuota" name="totalQuota" value="${totalQuota!}" size="10" maxlength="10" /> 元 ( 整數 )</td>
    </tr>
</table>
<br>
