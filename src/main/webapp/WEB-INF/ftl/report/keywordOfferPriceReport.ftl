...
<h2><img src="<@s.url value="/" />html/img/iconcr.gif" hspace="2" vspace="12" align="absmiddle" />關鍵字出價報表</h2>

<form action="keywordOfferPriceReport.html" method="post">
...
<table class="table01" width="950">
    <tr>
        ...
        <td class="td01" width="100">出價</td>
        <td class="td01" width="100">關鍵字</td>
        <td class="td01" width="100">分類</td>
        <td class="td01" width="100">廣告</td>
    ...
    <tr>
        ...
        <td class="td04">${data.offerPrice!}</td>
