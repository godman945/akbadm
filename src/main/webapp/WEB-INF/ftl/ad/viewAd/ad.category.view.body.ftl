...
<div class="cont">
	<h2>
		<img src="<@s.url value="/" />html/img/iconcr.gif" hspace="2" vspace="12" align="absmiddle" />廣告類別設定
	</h2>
		    ...
		    <form method="post" id="searchForm" name="searchForm">
				<table width="90%" height=60px; >
					<tr>
						...
						<td width="10%" align="left"><input type="button" id="add" name="add" value="新增類別" onclick="addAdCategory()" ></td>
					</tr>
				</table>
			</form>
		</div>
