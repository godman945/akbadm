		...
		<#if dataList?exists>
		    <#list dataList as vo>
				<tr>
					...
					<td class="td01"><a href="javascript:updateAdCategory('${vo.id!}','${vo.name!}');">修改</a></td>
					<td class="td01">
						<#if vo.level != 4>
...
<div style="display:none;" id="adCategoryDiv">
	<table width="500" class="table01" style="clear:both;background:#e4e3e0">
		<tr style="height:35px;">
			<th id="adCategoryDivTitle" style="font-size:20px;font-weight:bold;font-family:標楷體;">新增類別</th>
		</tr>
