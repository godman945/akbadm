...
<h2><img src="<@s.url value="/" />html/img/iconcr.gif" hspace="2" vspace="12" align="absmiddle" />聯播網址查詢</h2>
    ...
    <tr>
        <td>查詢日期 : 
        	...
        	<select id="searchOption" name="searchOption">
                ...
                <option value="websiteDisplayUrl">網站網址</option>
		    </select>
...
<table id="tableView" class="table01 tablesorter">
    <thead>
	    <tr>
	        ...
	        <th class="td09">網站網址</td>
	        <th class="td09">聯播網址數</td>
    ...
    <tbody>
	    ...
	    <tr>
	        ...
	        <td class="td09"><a onclick="fundDetalView('${data.customerInfoId}','${data.adPvclkDate}');">${data.adPvclkUrl}</a></td>
    ...
    <tr>
    	<td class="td09" colspan="6" style="background-color:#99FFFF;" >總計：${totalSize!}筆</td>
