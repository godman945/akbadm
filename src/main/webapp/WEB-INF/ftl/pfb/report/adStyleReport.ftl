...
<h2><img src="<@s.url value="/" />html/img/iconcr.gif" hspace="2" vspace="12" align="absmiddle" />樣式成效查詢</h2>
        ...
        <td>查詢日期 : 
           ...
           樣式 : 
            <select id="style" name="style" >
            	...
            	<option value= "文字">文字廣告</option>
            	<option value= "圖像">圖像廣告</option>
            	<option value= "圖文">圖文廣告</option>
            	<option value= "影音">影音廣告</option>
		    </select>
		    <input type="hidden" id="searchStyle" value="${style!}" />
		    <br/>
            <BR>查詢條件 : 
    ...
    <tbody>
	    <#list voList as data>
		    <tr>
		        ...
		        <td class="td09">${data.adPvclkStyle}</td>
