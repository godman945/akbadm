...
<h2><img src="<@s.url value="/" />html/img/iconcr.gif" hspace="2" vspace="12" align="absmiddle" />廣告客戶成效表</h2>
    ...
    <tr>
        <td>查詢日期:
        	...
        	<select id="searchOption" name="searchOption">
                ...
                <option value="customer">廣告客戶</option>
		    </select>
...
<table class="table01" width="950">
    ...
    <tr>
        ...
        <td class="td03">${data.adPvClkCustomer}</td>
