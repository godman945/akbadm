...
<table border="1" valign="top">
	...
	<tr valign="top" align='center'>
		<td colspan="3">
			...
			pad_positionId="PFBP201711060004C";
			</script>
			<script id="pcadscript" language="javascript" src="http://showstg.pchome.com.tw/adm/html/js/kernel/pcadshowstg2.js"></script>
	...
	<tr valign="top" align='center'>
		<td colspan="3">
			...
			pad_height=390;
			pad_customerId="PFBC20150519001";
			pad_positionId="PFBP201711060002C";
			</script>
			<script id="pcadscript" language="javascript" src="http://showstg.pchome.com.tw/adm/html/js/kernel/pcadshowstg2.js"></script>
	...
	<tr valign="top">
		<td colspan="3">
			...
			pad_height=250;
			pad_customerId="PFBC20150519001";
			pad_positionId="PFBP201711060005C";
			</script>
			<script id="pcadscript" language="javascript" src="http://showstg.pchome.com.tw/adm/html/js/kernel/pcadshowstg2.js"></script>
	...
	<tr valign="top" align='center'>
		<td>
			...
			pad_height=600;
			pad_customerId="PFBC20150519001";
			pad_positionId="PFBP201510120006C";
			</script>
			<script id="pcadscript" language="javascript" src="http://showstg.pchome.com.tw/adm/html/js/kernel/pcadshowstg2.js"></script>
		...
		<td>
			...
			pad_height=600;
			pad_customerId="PFBC20150519001";
			pad_positionId="PFBP201510120007C";
			</script>
			<script id="pcadscript" language="javascript" src="http://showstg.pchome.com.tw/adm/html/js/kernel/pcadshowstg2.js"></script>
		</td>
		<td>
