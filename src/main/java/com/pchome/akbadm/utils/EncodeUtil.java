...
public class EncodeUtil {
    ...
    public static void main(String[] args) {
    	...
    	String testEncode = EncodeUtil.getInstance().encryptAES(test, CookieConstants.COOKIE_SECRET_KEY);
    	System.out.println(">>> testEncode = " + testEncode);
    	String testDecode = EncodeUtil.getInstance().decryptAES(testEncode, CookieConstants.COOKIE_SECRET_KEY);
