...
public class PfdAdTimeReportDAO extends BaseDAO<PfdAdTimeReport, Integer> implements IPfdAdTimeReportDAO  {
		...
		List<Object> result = getHibernateTemplate().execute(
				new HibernateCallback<List<Object>>() {
                    ...
                    public List<Object> doInHibernate(Session session) throws HibernateException {
						...
						hql.append(" group by r.pfd_customer_info_id, r.pfd_user_id, r.customer_info_id, r.ad_type, r.ad_action_seq, r.ad_group_seq, r.ad_pvclk_device, r.time_code");
	...
	public void deleteReportDataByReportDate(String reportDate) throws Exception {
		String sql = "delete from PfdAdTimeReport where adPvclkDate = '" + reportDate + "'";
	...
	public int updateConvertCountData(String convertDate,String convertRangeDate) throws Exception {
		...
		sql.append(" UPDATE pfd_ad_time_report r, ");
		sql.append(" (	SELECT  ");
