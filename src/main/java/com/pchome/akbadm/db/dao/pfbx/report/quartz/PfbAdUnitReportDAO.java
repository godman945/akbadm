...
public class PfbAdUnitReportDAO extends BaseDAO<PfbxAdUnitReport, Integer> implements IPfbAdUnitReportDAO {
	...
	public void deleteReportDataByReportDate(String reportDate) throws Exception {
		String sql = "delete from PfbxAdUnitReport where adPvclkDate = '" + reportDate + "'";
