...
public class PfbAdDeviceReportDAO extends BaseDAO<PfbxAdDeviceReport, Integer> implements IPfbAdDeviceReportDAO {
		...
		List<Object> result = (List<Object>) getHibernateTemplate().execute(
				new HibernateCallback<List<Object>>() {
					public List<Object> doInHibernate(Session session) throws HibernateException, SQLException {
						...
						hql.append(" group by r.ad_pvclk_device, r.pfbx_customer_info_id");
	...
	public void deleteReportDataByReportDate(String reportDate) throws Exception {
		String sql = "delete from PfbxAdDeviceReport where adPvclkDate = '" + reportDate + "'";
