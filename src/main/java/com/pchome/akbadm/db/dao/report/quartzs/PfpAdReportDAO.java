...
public class PfpAdReportDAO extends BaseDAO<PfpAdReport, Integer> implements IPfpAdReportDAO {
		...
		List<Object> result = getHibernateTemplate().execute(
				new HibernateCallback<List<Object>>() {
                    ...
                    public List<Object> doInHibernate(Session session) throws HibernateException {
						...
						hql.append(" group by r.customer_info_id, r.ad_type, r.ad_group_seq, r.ad_seq, r.ad_pvclk_device, r.ad_pvclk_os,ad_price_type");
    ...
    public Integer deleteReportDataByReportDate(Date reportDate) throws Exception {
		...
		//StringBuffer hql = new StringBuffer();
		hql.append(" delete from PfpAdReport where adPvclkDate = ? ");

		return super.getHibernateTemplate().bulkUpdate(hql.toString(), reportDate);
	}
