...
public class PfbAdGroupReportDAO extends BaseDAO<PfbxAdGroupReport, Integer> implements IPfbAdGroupReportDAO {
		...
		List<Object> result = (List<Object>) getHibernateTemplate().execute(
				new HibernateCallback<List<Object>>() {
					public List<Object> doInHibernate(Session session) throws HibernateException {
						...
						hql.append(" r.pfbx_user_group_id ");
						hql.append(" from pfp_ad_pvclk_user_group as r");
						...
						hql.append(" group by  r.pfbx_customer_info_id, r.pfbx_user_group_id");
	...
	public void deleteReportDataByReportDate(String reportDate) throws Exception {
		String sql = "delete from PfbxAdGroupReport where adPvclkDate = '" + reportDate + "'";
