...
public class PfpAdTimeReportDAO extends BaseDAO<PfpAdTimeReport, Integer> implements IPfpAdTimeReportDAO {
		...
		List<Object> result = getHibernateTemplate().execute(
				new HibernateCallback<List<Object>>() {
                    ...
                    public List<Object> doInHibernate(Session session) throws HibernateException {
						...
						hql.append(" group by r.customer_info_id, r.ad_type, r.ad_action_seq, r.ad_group_seq, r.ad_pvclk_device, r.time_code,r.ad_price_type");
    ...
    public void deleteReportDataByReportDate(String reportDate) throws Exception {
		String sql = "delete from PfpAdTimeReport where adPvclkDate = '" + reportDate + "'";
	...
	public int updateConvertCountData(String convertDate,String convertRangeDate) throws Exception {
		...
		sql.append(" UPDATE pfp_ad_time_report r,  ");
		sql.append(" (  ");
		sql.append(" SELECT ");
