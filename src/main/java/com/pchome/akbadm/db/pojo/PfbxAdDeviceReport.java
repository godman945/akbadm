...
/**
 * PfbxAdDeviceReport generated by hbm2java
 */
@Entity
@Table(name = "pfbx_ad_device_report")
public class PfbxAdDeviceReport implements java.io.Serializable {

	private Integer adDeviceReportSeq;
	...
	public PfbxAdDeviceReport() {
	}

	public PfbxAdDeviceReport(Date adPvclkDate, String customerInfoId, int adPv, int adClk, int adInvalidClk,
	...
	public PfbxAdDeviceReport(Date adPvclkDate, String adPvclkDevice, String customerInfoId, int adPv, int adClk,
	...
	@Column(name = "ad_device_report_seq", unique = true, nullable = false)
	public Integer getAdDeviceReportSeq() {
		return this.adDeviceReportSeq;
	}

	public void setAdDeviceReportSeq(Integer adDeviceReportSeq) {
		this.adDeviceReportSeq = adDeviceReportSeq;
	}
