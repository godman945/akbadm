...
/**
 * PfbForegroundAccountNoId generated by hbm2java
 */
@Embeddable
public class PfbForegroundAccountNoId implements java.io.Serializable {
	...
	public PfbForegroundAccountNoId() {
	}

	public PfbForegroundAccountNoId(String year, String season, String month, String day, String hash) {
		this.year = year;
		this.season = season;
		this.month = month;
		this.day = day;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PfbForegroundAccountNoId))
			return false;
		PfbForegroundAccountNoId castOther = (PfbForegroundAccountNoId) other;
