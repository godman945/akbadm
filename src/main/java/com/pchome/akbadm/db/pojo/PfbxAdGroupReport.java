...
/**
 * PfbxAdGroupReport generated by hbm2java
 */
@Entity
@Table(name = "pfbx_ad_group_report")
public class PfbxAdGroupReport implements java.io.Serializable {

	private Integer adGroupReportSeq;
	private Date adPvclkDate;
	private String adPvclkGroup;
	...
	public PfbxAdGroupReport() {
	}

	public PfbxAdGroupReport(Date adPvclkDate, String customerInfoId, int adPv, int adClk, int adInvalidClk,
	...
	public PfbxAdGroupReport(Date adPvclkDate, String adPvclkGroup, String customerInfoId, int adPv, int adClk,
			int adInvalidClk, float adPvPrice, float adClkPrice, float adInvalidClkPrice, Date createDate,
			Date updateDate) {
		this.adPvclkDate = adPvclkDate;
		this.adPvclkGroup = adPvclkGroup;
		this.customerInfoId = customerInfoId;
		this.adPv = adPv;
		this.adClk = adClk;
		this.adInvalidClk = adInvalidClk;
	...
	@Column(name = "ad_pvclk_group", length = 20)
	public String getAdPvclkGroup() {
		return this.adPvclkGroup;
	}

	public void setAdPvclkGroup(String adPvclkGroup) {
		this.adPvclkGroup = adPvclkGroup;
	}
