...
/**
 * PfbxAdSizeReport generated by hbm2java
 */
@Entity
@Table(name = "pfbx_ad_size_report")
public class PfbxAdSizeReport implements java.io.Serializable {

	private Integer adSizeReportSeq;
	private Date adPvclkDate;
	private String adPvclkSize;
	...
	public PfbxAdSizeReport() {
	}

	public PfbxAdSizeReport(Date adPvclkDate, String customerInfoId, int adPv, int adClk, int adInvalidClk,
	...
	public PfbxAdSizeReport(Date adPvclkDate, String adPvclkSize, String customerInfoId, int adPv, int adClk,
	...
	@Column(name = "ad_size_report_seq", unique = true, nullable = false)
	public Integer getAdSizeReportSeq() {
		return this.adSizeReportSeq;
	}

	public void setAdSizeReportSeq(Integer adSizeReportSeq) {
		this.adSizeReportSeq = adSizeReportSeq;
	}
	...
	@Column(name = "ad_pvclk_size", length = 20)
	public String getAdPvclkSize() {
		return this.adPvclkSize;
	}
