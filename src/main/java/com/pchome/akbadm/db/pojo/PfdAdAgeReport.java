...
/**
 * PfdAdAgeReport generated by hbm2java
 */
@Entity
@Table(name = "pfd_ad_age_report")
public class PfdAdAgeReport implements java.io.Serializable {
	...
	public PfdAdAgeReport() {
	}

	public PfdAdAgeReport(Date adPvclkDate, String adPvclkDevice, String pfpCustomerInfoId, String adActionSeq,
	...
	public PfdAdAgeReport(Date adPvclkDate, String adPvclkDevice, String pfdCustomerInfoId, String pfdUserId,
			String pfpCustomerInfoId, String adActionSeq, String adGroupSeq, int adType, String adOperatingRule,
			String adClkPriceType, String sex, String ageCode, int adPv, int adVpv, int adClk, int adView,
			int adInvalidClk, float adClkPrice, float adInvalidClkPrice, Integer convertCount,
