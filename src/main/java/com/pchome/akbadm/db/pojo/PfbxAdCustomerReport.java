...
/**
 * PfbxAdCustomerReport generated by hbm2java
 */
@Entity
@Table(name = "pfbx_ad_customer_report")
public class PfbxAdCustomerReport implements java.io.Serializable {

	private Integer adCustomerReportSeq;
	private Date adPvclkDate;
	private String adPvclkCustomer;
	...
	public PfbxAdCustomerReport() {
	}

	public PfbxAdCustomerReport(Date adPvclkDate, String customerInfoId, int adPv, int adClk, int adInvalidClk,
	...
	public PfbxAdCustomerReport(Date adPvclkDate, String adPvclkCustomer, String customerInfoId, int adPv, int adClk,
	...
	@Column(name = "ad_customer_report_seq", unique = true, nullable = false)
	public Integer getAdCustomerReportSeq() {
		return this.adCustomerReportSeq;
	}

	public void setAdCustomerReportSeq(Integer adCustomerReportSeq) {
		this.adCustomerReportSeq = adCustomerReportSeq;
	}
	...
	@Column(name = "ad_pvclk_customer", length = 20)
	public String getAdPvclkCustomer() {
		return this.adPvclkCustomer;
	}
