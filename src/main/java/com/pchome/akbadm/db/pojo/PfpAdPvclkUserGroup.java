...
/**
 * PfpAdPvclkUserGroup generated by hbm2java
 */
@Entity
@Table(name = "pfp_ad_pvclk_user_group")
public class PfpAdPvclkUserGroup implements java.io.Serializable {

	private Integer adPvclkUserGroupId;
	private String pfbxCustomerInfoId;
	private String pfbxUserGroupId;
	...
	public PfpAdPvclkUserGroup() {
	}

	public PfpAdPvclkUserGroup(String pfbxCustomerInfoId, String pfbxUserGroupId, Date adPvclkDate, int adPvclkTime,
			int adPv, int adClk, int adInvalidClk, float adPvPrice, float adClkPrice, float adInvalidClkPrice,
			String adPvclkDevice, Date updateDate, Date createDate) {
		this.pfbxCustomerInfoId = pfbxCustomerInfoId;
		this.pfbxUserGroupId = pfbxUserGroupId;
	...
	@Column(name = "ad_pvclk_user_group_id", unique = true, nullable = false)
	public Integer getAdPvclkUserGroupId() {
		return this.adPvclkUserGroupId;
	}

	public void setAdPvclkUserGroupId(Integer adPvclkUserGroupId) {
		this.adPvclkUserGroupId = adPvclkUserGroupId;
	}
	...
	@Column(name = "pfbx_user_group_id", nullable = false, length = 20)
	public String getPfbxUserGroupId() {
		return this.pfbxUserGroupId;
	}

	public void setPfbxUserGroupId(String pfbxUserGroupId) {
		this.pfbxUserGroupId = pfbxUserGroupId;
	}
