...
/**
 * PfbxAdUrlReport generated by hbm2java
 */
@Entity
@Table(name = "pfbx_ad_url_report")
public class PfbxAdUrlReport implements java.io.Serializable {

	private Integer adUrlReportSeq;
	private Date adPvclkDate;
	private String adPvclkUrl;
	...
	public PfbxAdUrlReport() {
	}

	public PfbxAdUrlReport(Date adPvclkDate, String customerInfoId, int adPv, int adClk, int adInvalidClk,
	...
	public PfbxAdUrlReport(Date adPvclkDate, String adPvclkUrl, String customerInfoId, int adPv, int adClk,
	...
	@Column(name = "ad_url_report_seq", unique = true, nullable = false)
	public Integer getAdUrlReportSeq() {
		return this.adUrlReportSeq;
	}

	public void setAdUrlReportSeq(Integer adUrlReportSeq) {
		this.adUrlReportSeq = adUrlReportSeq;
	}
	...
	@Column(name = "ad_pvclk_url", length = 50)
	public String getAdPvclkUrl() {
		return this.adPvclkUrl;
	}
