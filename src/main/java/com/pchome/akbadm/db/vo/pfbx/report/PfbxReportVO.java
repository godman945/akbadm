...
public class PfbxReportVO {

	private String websiteChineseName;  //網站中文名稱
	private String websiteDisplayUrl;	//網站播放網址
	private String websiteCategory;		//帳戶類型
	
	private String adPvclkDate;			//廣告曝光點擊數日期
	private String adPvclkUnit;			//廣告曝光點擊數單位
	private String adPvclkSize;			//廣告尺寸
	private String adPvclkStyle;		//廣告尺寸
	private String adPvclkUrl;			//廣告網址
	...
	public String getAdPvclkSize() {
		return adPvclkSize;
	}

	public void setAdPvclkSize(String adPvclkSize) {
		this.adPvclkSize = adPvclkSize;
	}
	...
	public void setTotalBonus(String totalBouns) {
		this.totalBonus = totalBouns;
	}
	...
	public String getAdPvclkUrl() {
		return adPvclkUrl;
	}

	public void setAdPvclkUrl(String adPvclkUrl) {
		this.adPvclkUrl = adPvclkUrl;
	}
