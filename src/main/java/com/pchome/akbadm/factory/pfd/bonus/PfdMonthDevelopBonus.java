...
public class PfdMonthDevelopBonus extends APfdBonusItem{

	private final EnumPfdBonusItem pfdBonusItem = EnumPfdBonusItem.EVERY_MONTH_DEVELOP_BONUS;
	...
	@Override
	public float getPvclkPrice(String pfdId, String startDate, String endDate,
			EnumPfdAccountPayType enumPfdAccountPayType) {
