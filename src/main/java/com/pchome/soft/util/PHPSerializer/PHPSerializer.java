...
package com.pchome.soft.util.PHPSerializer;
...
public final class PHPSerializer {
    private static final Log log = LogFactory.getLog(PHPSerializer.class);
    ...
    private int serialize(ByteArrayOutputStream stream, Object obj, HashMap ht,
            int hv) throws IllegalAccessException, IllegalArgumentException,
    ...
    private void writeCalendar(ByteArrayOutputStream stream, Calendar calendar) {
        ...
        writeInteger(stream, getAsciiBytes(new Integer(calendar
                .get(Calendar.YEAR))));
    ...
    private int writeArray(ByteArrayOutputStream stream, Object a, HashMap ht,
            int hv) throws IllegalAccessException, IllegalArgumentException,
            InvocationTargetException {
    ...
    private int writeCollection(ByteArrayOutputStream stream, Collection c,
            HashMap ht, int hv) throws IllegalAccessException,
            IllegalArgumentException, InvocationTargetException {
        int len = c.size();
        byte[] alen = getAsciiBytes(new Integer(len));
        stream.write(__a);
    ...
    private int writeList(ByteArrayOutputStream stream, List a, HashMap ht,
            int hv) throws IllegalAccessException, IllegalArgumentException,
            InvocationTargetException {
        int len = a.size();
        byte[] alen = getAsciiBytes(new Integer(len));
    ...
    private int writeMap(ByteArrayOutputStream stream, Map h, HashMap ht, int hv)
        ...
        for (Iterator keys = h.keySet().iterator(); keys.hasNext();) {
            ...
            if ((key instanceof Byte) || (key instanceof Short)
                ...
                writeInteger(stream, new byte[] { ((Boolean) key)
                        .booleanValue() ? __1 : __0 });
            } else {
    ...
    private int writeObject(ByteArrayOutputStream stream, Object obj,
        ...
        /*
         * if (obj instanceof org.phprpc.util.Serializable) { byte[] cs =
         * ((org.phprpc.util.Serializable) obj).serialize(); byte[] cslen =
         * getAsciiBytes(new Integer(cs.length)); stream.write(__C);
         * stream.write(__Colon); stream.write(classNameLen, 0,
         * classNameLen.length); stream.write(__Colon); stream.write(__Quote);
         * stream.write(className, 0, className.length); stream.write(__Quote);
         * stream.write(__Colon); stream.write(cslen, 0, cslen.length);
         * stream.write(__Colon); stream.write(__LeftB); stream.write(cs, 0,
         * cs.length); stream.write(__RightB); } else {
         */
        HashMap f;
        Method __sleep = null;
    ...
    private Object unserialize(ByteArrayInputStream stream,
            ArrayList objectContainer) throws IllegalAccessException,
            IllegalArgumentException, InvocationTargetException {
        Object obj;
    ...
    private Calendar readCalendar(ByteArrayInputStream stream,
            ArrayList objectContainer, int n) {
        ...
        stream.skip(1);
        GregorianCalendar calendar = new GregorianCalendar(((Integer) dt
                .get("year")).intValue(), ((Integer) dt.get("month"))
                .intValue() - 1, ((Integer) dt.get("day")).intValue(),
                ((Integer) dt.get("hour")).intValue(), ((Integer) dt
                        .get("minute")).intValue(),
    ...
    private Object readCustomObject(ByteArrayInputStream stream,
         ...
         * else if (o instanceof org.phprpc.util.Serializable) { byte[] b = new
         * byte[n]; stream.read(b, 0, n); ((org.phprpc.util.Serializable)
         * o).unserialize(b); }
         */
        else {
            stream.skip(n);
...
//
//            String phStr="a:6:{s:12:\"new_online_h\";a:17:{i:42;i:1;i:0;i:1;i:14;i:1;i:23;i:1;i:1;i:1;i:7;i:1;i:26;i:1;i:11;i:1;i:28;i:1;i:61;i:1;i:62;i:1;i:63;i:1;i:64;i:1;i:65;i:1;i:66;i:1;i:24;i:1;i:16;i:1;}s:24:\"new_online_h_project_two\";a:6:{i:0;i:1;i:1;i:1;i:14;i:1;i:23;i:1;i:10;i:1;i:48;i:1;}s:21:\"new_online_h_live_one\";a:8:{i:57;i:1;i:45;i:1;i:0;i:1;i:1;i:1;i:14;i:1;i:23;i:1;i:48;i:1;i:59;i:1;}s:21:\"new_online_h_live_two\";a:4:{i:57;i:1;i:45;i:1;i:48;i:1;i:59;i:1;}s:23:\"new_online_h_live_three\";a:3:{i:57;i:1;i:45;i:1;i:59;i:1;}s:20:\"new_online_h_project\";a:5:{i:1;i:1;i:14;i:1;i:23;i:1;i:10;i:1;i:48;i:1;}}";
//            AssocArray a=(AssocArray)ps.unserialize(phStr.getBytes());
//
//            //LinkedList<LinkedHashMap<String,String>> resultList=new LinkedList<LinkedHashMap<String,String>>();
...
//                    ps.assocArrayToMap((AssocArray)valueO,String.valueOf(key),resultMap);
//                }else{
//                    //System.out.println("is not array");
//                    //ps.objectToMap((String)key,(Object)valueO,resultList);
//                    ps.objectToMap((String)key,valueO,resultMap);
//                }
//            }
//
...
//            */
//
//            for(String ch:resultMap.keySet()){
//
//                System.out.println("------------" + ch + "--------------");
//                LinkedHashMap<String,String> dataResultMap=resultMap.get(ch);
//
//                for(String k:dataResultMap.keySet()){
//                    System.out.println(k+"="+dataResultMap.get(k));
//                }
//            }
...
//    }
    ...
    public  void objectToMap(String key,Object valueO,LinkedList<LinkedHashMap<String,String>> resultList){
        LinkedHashMap<String,String> resultMap=new LinkedHashMap<String,String>();

        resultMap.put(key, (String)Cast.cast(valueO,String.class,"UTF-8"));

        if(!resultMap.isEmpty()){
            resultList.addFirst(resultMap);
        }
    }

    public  void objectToMap(String key,Object valueO,LinkedHashMap<String,LinkedHashMap<String,String>> mainResultMap){
        LinkedHashMap<String,String> resultMap=new LinkedHashMap<String,String>();

        resultMap.put(key, (String)Cast.cast(valueO,String.class,"UTF-8"));

        if(!resultMap.isEmpty()){
            mainResultMap.put(key, resultMap);
        }
    }

    public  void assocArrayToMap(AssocArray assocArray,LinkedList<LinkedHashMap<String,String>> resultList){
        LinkedHashMap<String,String> resultMap=new LinkedHashMap<String,String>();

        HashMap bbb=assocArray.toHashMap();
        ...
        if(!bbb.isEmpty()){
            ...
            for(Object key:bbb.keySet()){
                ...
                if(valueO instanceof AssocArray ){
                    //System.out.println("is array");
                    assocArrayToMap((AssocArray)valueO,resultList);
                }else{
                    resultMap.put(String.valueOf(key), (String)Cast.cast(valueO.toString(),String.class,"UTF-8"));
                }
            }
    ...
    public  void assocArrayToMap(AssocArray assocArray,String mapKey,LinkedHashMap<String,LinkedHashMap<String,String>> mainResultMap){
        LinkedHashMap<String,String> resultMap=new LinkedHashMap<String,String>();
        ...
        if(!bbb.isEmpty()){
            ...
            for(Object key:bbb.keySet()){
                ...
                if(valueO instanceof AssocArray ){
                    //System.out.println("is array");
                    assocArrayToMap((AssocArray)valueO,mapKey,mainResultMap);
                }else{
                    resultMap.put(String.valueOf(key), (String)Cast.cast(valueO.toString(),String.class,"UTF-8"));
                }
            }
            ...
            if(!resultMap.isEmpty()){
                mainResultMap.put(mapKey, resultMap);
            }
        }
    }
}